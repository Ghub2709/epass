        ...
        <div className="flex flex-col sm:flex-row justify-between items-center p-4 border-b gap-3">
          ...
          <div className="flex gap-2 w-full sm:w-auto justify-center sm:justify-end">
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-white px-3 py-2 sm:px-4 sm:py-2 rounded flex items-center gap-1 sm:gap-2 transition-colors text-sm sm:text-base flex-grow sm:flex-grow-0 justify-center"
            >
            ...
            <button
              onClick={onClose}
              className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-3 py-2 sm:px-4 sm:py-2 rounded flex items-center gap-1 sm:gap-2 transition-colors text-sm sm:text-base flex-grow sm:flex-grow-0 justify-center"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
